...
CREATE INDEX IF NOT EXISTS idx_students_card_code ON students(card_code);
...
CREATE INDEX IF NOT EXISTS idx_exam_events_school_year ON exam_events(school_year);
