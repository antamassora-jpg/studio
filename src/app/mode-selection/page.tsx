        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Kelola data siswa, cetak kartu, dan lihat rekap absensi.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full group-hover:bg-primary group-hover:text-white">Pilih Admin</Button>
            </CardContent>
          </Card>

          <Card 
            className="hover:border-secondary cursor-pointer transition-all hover:shadow-lg group"
          ...
          >
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl">Mode Scanner</CardTitle>
              <CardDescription>
                Scan kartu pelajar untuk absensi harian siswa.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full group-hover:bg-secondary group-hover:text-white">Pilih Scanner</Button>
            </CardContent>
          </Card>
        </div>
